            ...
            >
              <Dialog.Panel className="relative flex w-full max-w-xs flex-col overflow-y-auto bg-white pb-12 shadow-xl" style={{ backgroundColor: mode === 'dark' ? 'rgb(40, 44, 52)' : '', color: mode === 'dark' ? 'white' : '', }}>
                ...
                <div className="space-y-6 border-t border-gray-200 px-4 py-6">
                  ...
                  {user?.user?.email === "alkaraojnv@gmail.com" ? <div className="flow-root">
              ...
              <div className="ml-auto flex items-center">
                ...
                <Link to={'/'} className="text-sm font-medium text-gray-900 " style={{ color: mode === 'dark' ? 'white' : '', }}>
                 ...
                 {user ?  <Link to={'/order'} className="text-sm font-medium text-gray-700 " style={{ color: mode === 'dark' ? 'white' : '', }}>
                  ...
                  {user?.user?.email === 'alkaraojnv@gmail.com' ? 
               ...
               { user ? <div className="hidden lg:ml-8 lg:flex">
                ...
                <div className="ml-4 flow-root lg:ml-6">
                  <Link to={'/wishlist'} className="group -m-2 flex items-center p-2" style={{ color: mode === 'dark' ? 'white' : '', }}>
                    ...
                    <span className="ml-2 text-sm font-medium text-gray-700 group-" style={{ color: mode === 'dark' ? 'white' : '', }}>{wishlistItems.length}</span>
                    <span className="sr-only">items in cart, view bag</span>
                  </Link>
                </div>
